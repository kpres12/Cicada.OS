...
References: Sentry-style NEO trackers (phosphor HUD), Evangelion MAGI/VFD gauges, OT-era tactical consoles. Not generic cyberpunk purple.
...
Type: JetBrains Mono (system). HUD labels are ALL CAPS, tracked out, never sentence case.

## Rules

- Square corners. No drop shadows. Thin 1–2px borders.
- Density over chrome: status is a console, not a candy bar.
- Motion is status (workspace slide), not decoration.
